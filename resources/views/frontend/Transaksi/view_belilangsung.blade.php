...
@section('content')
                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        ...
                        <div class="breadcrumb__option">
                            ...
                            <a href="./index.html">Checkout Produk</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="shoping__cart__table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="shoping__cart__item">
                                                <img src="{{asset('gambar/'.$bl->gambar)}}" alt="" style="width: 70px;">
                                                <h5>{{$bl->nama_barang}}</h5>
                                            </td>
                                            ...
                                            <td class="shoping__cart__price">
                                                Rp. {{number_format($bl->harga)}}
                                            </td>

                                            {{-- <td class="shoping__cart__total">
                                                Rp.{{number_format($bl->total)}}
                                            </td> --}}
                                        </tr>
                                    </tbody>
                                    @php
                            ...
                            <div class="card-footer  bg-transparent">
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <h5 class="font-weight-bold">Rp. {{number_format($bl->total)}}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <form action="{{route('send.result.midtrans.langsung')}}" method="post" id="myForm">
        @csrf
    ...
    <script type="text/javascript">
        ...
        else
        {
            $.ajax({
                type: "post",
                url: "{{route('get.snaptoken.langsung')}}",
                data : {
